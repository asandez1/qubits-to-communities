...
- **Society model (v2)**: frozen Pydantic domain model (age, energy, schedules, households, tools, vehicles, urgency), cycle engine, full simulation history with JSONL persistence (`experiments/SOCIETY_MODEL.md`)
